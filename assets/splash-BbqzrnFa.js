import{_ as x,n as o}from"./index-C3CtvK1P.js";function u(e,i={}){if(i.aguardandoAprovacao){e.innerHTML=`
      <div style="
    ...
    `,document.getElementById("btnSair").onclick=async()=>{const{supabase:t}=await x(async()=>{const{supabase:s}=await import("./index-C3CtvK1P.js").then(a=>a.i);return{supabase:s}},[]);await t.auth.signOut(),o("login")};return}if(i.escolhaPerfil){c(e);return}e.innerHTML=`
    <div style="
