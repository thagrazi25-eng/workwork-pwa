import{n as r,h as l,u as c,t as s,_ as x}from"./index-BMRtjzvn.js";async function m(t){t.innerHTML=`
  ...
  `,document.getElementById("btnSair").onclick=p}function u(){const t=document.getElementById("btnTrocarAvatar"),o=document.getElementById("inputAvatar");t&&o&&(t.onclick=()=>o.click(),o.onchange=async i=>{const e=i.target.files[0];if(e)try{t.innerHTML="⏳";const n=await c(e);document.getElementById("avatarCircle").innerHTML=`<img src="${n}?t=${Date.now()}" style="width:100%;height:100%;object-fit:cover;" />`,t.innerHTML="📷",s("Foto atualizada!","success")}catch{t.innerHTML="📷",s("Erro ao enviar foto","error")}})}async function p(){const{supabase:t}=await x(async()=>{const{supabase:o}=await import("./index-BMRtjzvn.js").then(i=>i.i);return{supabase:o}},[]);await t.auth.signOut(),r("login")}const a=t=>`
